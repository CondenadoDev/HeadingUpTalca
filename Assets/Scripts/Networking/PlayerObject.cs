...
public class PlayerObject : NetworkBehaviour
{
    ...
    [Networked, OnChangedRender(nameof(StatChanged))]
    public bool checkMark { get; private set; }
    [Networked]
    ...
    [Networked]
    public float StackedTime { get; set; } = 0f;
    [Networked]
    ...
    public override void Spawned()
    {
        ...
        {
            Local = this;
            Rpc_SetNickname(!string.IsNullOrWhiteSpace(SaveDataManager.Instance.PlayerNickname) ? SaveDataManager.Instance.PlayerNickname : $"Golfer{Random.Range(100, 1000)}");
        }
    ...
    [Rpc(RpcSources.InputAuthority, RpcTargets.StateAuthority)]
    public void Rpc_SetCheckMark(bool value)
    {
        checkMark = value;
    }
    ...
    [Rpc(RpcSources.InputAuthority, RpcTargets.StateAuthority)]
    public void Rpc_SetSkin(string skin)
    {
        Skin = skin;
    }
